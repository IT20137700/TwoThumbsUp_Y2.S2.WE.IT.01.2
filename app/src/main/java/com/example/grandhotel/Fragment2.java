...
public class Fragment2 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Button bkfast_btn1 = (Button) view.findViewById(R.id.Burger_btn1);
        Button  bkfast_btn2= (Button) view.findViewById(R.id.Burger_btn3);
        Button dinner_btn2 = (Button) view.findViewById(R.id.Burger_btn2);
        ...
        bkfast_btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent in = new Intent(getActivity(), burger1.class);
                startActivity(in);
            }
        });
        ...
        bkfast_btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent in = new Intent(getActivity(), burger3.class);
                startActivity(in);
            }
        });
        ...
        dinner_btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent in = new Intent(getActivity(), burger2.class);
                startActivity(in);
            }
        });
